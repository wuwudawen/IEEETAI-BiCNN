...
# GSs and PDs
GSs = [(20, 20), (30, 30), (40, 40)]
PDs = [np.random.uniform, np.random.normal]
ARGS = [(0, 100), (50, 25)]
GSs_testing = [(25, 25), (35, 35)]
PDs_testing = [np.random.uniform, np.random.normal]
ARGS_testing = [(20, 80), (75, 25)]
